    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        {{ Form::open(['url' => route('workshop.confirm')]) }}
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                {{ Form::text('title', session('title'), ['class' => 'mt-1 block w-full', 'placeholder' => '例）〇〇制作']) }}
                @if ($errors->has('title'))
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                {{ Form::text('venue', session('venue'), ['class' => 'mt-1 block w-full', 'placeholder' => '例）東京都渋谷区〇〇']) }}
                @if ($errors->has('venue'))
            ...
            <!-- 参加費 -->
            <div class="col-span-6 sm:col-span-4">
                {{ Form::label('participationFee', __('Participation Fee')) }}
                {{ Form::text('participationFee', session('participationFee'), ['class' => 'mt-1 block w-full', 'placeholder' => '例）1000']) }}円
            ...
            <!-- 確認 -->
            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">確認</button>
        {{ Form::close() }}
    <div>
</x-app-layout>
